...
DELIMITER $$
CREATE PROCEDURE spAlterSenhaFunc(vLoginFuncionario varchar(100), vSenhaFunc varchar(100))

BEGIN
	UPDATE tb_funcionario set SenhaFuncionario = vSenhaFunc where LoginFuncionario = vLoginFuncionario;
END $$
